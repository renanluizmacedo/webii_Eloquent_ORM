            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('NOME: {{ $item->nome }}', 'E-MAIL: {{ $item->email }}', 'SIAPE: {{ $item->siape }}', 'EIXO: {{ $item->eixo->nome }}')" class="btn btn-primary">
                        ...
                        <a href="{{ route('professores.show',$item->id) }}" class="btn btn-warning">
