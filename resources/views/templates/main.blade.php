                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown ps-2">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                            ...
                            <span class="ps-1">Discentes e Docentes</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item ps-2 me-3"><a href="{{route('alunos.index')}}" class="dropdown-item">Alunos</a></li>
                            <li class="nav-item ps-2 me-3"><a href="{{route('professores.index')}}" class="dropdown-item ">Professores</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown ps-2">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                            ...
                            <span class="ps-1">Vinculos Institucionais</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li class="nav-item ps-2 me-3"><a href="{{route('docencias.index')}}" class="dropdown-item">Docencia</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown ps-2">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
